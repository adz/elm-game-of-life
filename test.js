...
var _user$project$BoardSpec$fromSpec = function (spec) {
	var charToCell = F2(
		function (x, y) {
	...
	return _elm_lang$core$Array$fromList(
		A2(
			_elm_lang$core$List$map,
			rowStringToRow,
			_elm_lang$core$String$lines(spec)));
};
var _user$project$BoardSpec$trimSpec = function () {
	...
	var onlyLinesWithContent = _elm_lang$core$List$filter(
		function (_p2) {
			return _elm_lang$core$Basics$not(
				_elm_lang$core$String$isEmpty(_p2));
		});
	return function (_p3) {
		return A2(
			_elm_lang$core$String$join,
...
var _user$project$BoardTests$testSingleCell = A2(
	_elm_community$elm_test$ElmTest$test,
	'Single cell board',
	A2(
		_elm_community$elm_test$ElmTest$assertEqual,
		A2(_user$project$Board$makeEmpty, 1, 1),
		_user$project$BoardSpec$fromSpec('.')));
var _user$project$BoardTests$filled2By3 = _user$project$BoardSpec$trimSpec('**\n                **\n                **\n                ');
var _user$project$BoardTests$testFilled = function () {
	var filledBoard = _user$project$BoardSpec$fromSpec(_user$project$BoardTests$filled2By3);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_community$elm_test$ElmTest$equals,
				A3(_user$project$Board$get, 0, 0, filledBoard),
				true),
				A2(
				_elm_community$elm_test$ElmTest$equals,
				A3(_user$project$Board$get, 1, 0, filledBoard),
				true),
				A2(
				_elm_community$elm_test$ElmTest$equals,
				A3(_user$project$Board$get, 0, 1, filledBoard),
				true),
				A2(
				_elm_community$elm_test$ElmTest$equals,
				A3(_user$project$Board$get, 1, 1, filledBoard),
				true),
				A2(
				_elm_community$elm_test$ElmTest$equals,
				A3(_user$project$Board$get, 0, 2, filledBoard),
				true),
				A2(
				_elm_community$elm_test$ElmTest$equals,
				A3(_user$project$Board$get, 1, 2, filledBoard),
				true),
				A2(
				_elm_community$elm_test$ElmTest$equals,
				A3(_user$project$Board$get, 9000, 9000, filledBoard),
				false)
			]));
}();
var _user$project$BoardTests$testKill = function () {
	var filledBoard = A3(
		_user$project$Board$kill,
		1,
		1,
		_user$project$BoardSpec$fromSpec(_user$project$BoardTests$filled2By3));
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Test killed correctly filled',
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_community$elm_test$ElmTest$equals,
...
var _user$project$BoardTests$testToSpecFilled = A2(
	_elm_community$elm_test$ElmTest$equals,
	_user$project$BoardSpec$toSpec(
		_user$project$BoardSpec$fromSpec(_user$project$BoardTests$filled2By3)),
	_user$project$BoardTests$filled2By3);
var _user$project$BoardTests$empty2By3 = _user$project$BoardSpec$trimSpec('..\n                ..\n                ..\n                ');
var _user$project$BoardTests$testEmpty = A2(
	_elm_community$elm_test$ElmTest$equals,
	A2(_user$project$Board$makeEmpty, 2, 3),
	_user$project$BoardSpec$fromSpec(_user$project$BoardTests$empty2By3));
var _user$project$BoardTests$testVivify = function () {
	var filledBoard = A3(
		_user$project$Board$vivify,
		1,
		1,
		_user$project$BoardSpec$fromSpec(_user$project$BoardTests$empty2By3));
	return A2(
...
var _user$project$BoardTests$testToSpec = A2(
	_elm_community$elm_test$ElmTest$equals,
	_user$project$BoardTests$empty2By3,
	_user$project$BoardSpec$toSpec(
		A2(_user$project$Board$makeEmpty, 2, 3)));
var _user$project$BoardTests$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Board construction tests',
	_elm_lang$core$Native_List.fromArray(
		[_user$project$BoardTests$testSingleCell, _user$project$BoardTests$testEmpty, _user$project$BoardTests$testFilled, _user$project$BoardTests$testToSpec, _user$project$BoardTests$testToSpecFilled, _user$project$BoardTests$testKill, _user$project$BoardTests$testVivify]));

var _user$project$Main$tests = _user$project$BoardTests$tests;
